...
public class Acquire {
	...
	/**
	 * The user can choose to preserve multiple instances for the same actor.
	 * 
	...
	/**
	 * The user can choose to enable the clock gating application.
	 * 
	 * This method read the choice (y/n) by the standard input and return this choice
	 * as a boolean object.
	 * 
	...
	/**
	 * The user can choose to merge different broadcasts with the same source port.
	 * 
	 * This method read the choice (y/n) by the standard input and return this choice
	 * as a boolean object.
	 * 
