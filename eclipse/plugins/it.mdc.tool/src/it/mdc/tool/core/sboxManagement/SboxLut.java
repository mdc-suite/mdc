package it.mdc.tool.core.sboxManagement;
...
public class SboxLut {
   ...
   */
  public Instance getSboxInstance() { return sboxInstance; }
   ...
   */
  public Set<Network> getNetworks() { return lutMap.keySet(); }
  ...
  public Network getNetworkByName(String netName) {
    return lutMap.keySet()
        .stream()
        .filter(net -> net.getSimpleName().equals(netName))
